...
In Column G, calculate the "Total Weekly Prescription Revenue" using the formula:
...
Using Google or ChatGPT, figure out how to add "Outside End" data labels to the histogram
