...
A computer was originally a person who did calculations, sometimes with the help of machines. This job title persisted until the late 1800s when the meaning of computer went from an occupation to a something closer to what we know and love today.

"As each increase of knowledge, as well on the contrivance of every new tool, human labour becomes abridged."
...
- Could be used for more than just one particular computation
- Could be given data and run operations in sequence
- Had memory and a primitive printer
- Implemented conditional branches and looping which all the computer nerds continue to love to this day.

The cons:

- Never fully constructed as it was way head of its time.
- Being "easily transportable" was not a top priority at the time

In summary: Having a series of operations performed automatically was a huge deal and would foreshadow our modern computer programs
