...
AI is all around us now, but the trick is to use it as a valuable resource, not as a shortcut to complete your work. Fun Fact: This is actually how I write these notes and it’s a core part of my workflow.

However, remember that each class has its own policy on AI use. For this class, consider it a tool to support your work, not a replacement for the effort you put in.
