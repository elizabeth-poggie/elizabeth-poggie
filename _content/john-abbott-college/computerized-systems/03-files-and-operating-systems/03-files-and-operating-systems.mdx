...
The Storage Disc or Storage Drive is where your software, documents, movies, and other files are kept for the long term. This means data is preserved even when the computer is turned off or unplugged.

When you run a program or open a file, the computer copies some data from the storage disc into RAM. When you save a file, it’s copied back to the storage disc.
...
Hardware is a complex topic, and next class, we’ll explore the world of Software!
