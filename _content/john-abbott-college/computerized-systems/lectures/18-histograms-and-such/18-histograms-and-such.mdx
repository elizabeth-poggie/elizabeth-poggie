...
_"What are the names, email addresses, and mailing addresses of all customers who ordered Product X in the last 3 months?"_
...
_Forms_ allow you to both add data to _tables_ and view data that already exists. _Reports_ present data from tables and also from _queries_, which then search for and analyze data within these same tables.
