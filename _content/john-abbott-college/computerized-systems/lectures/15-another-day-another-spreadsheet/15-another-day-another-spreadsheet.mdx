...
Soon, we’ll start writing queries to pull data from a table. Expect to make a lot of mistakes along the way, however that's 100% of the process. So, if you find yourself frustrated because the computer isn't doing what you want, remember it’s only doing exactly what you’ve instructed it to do.
