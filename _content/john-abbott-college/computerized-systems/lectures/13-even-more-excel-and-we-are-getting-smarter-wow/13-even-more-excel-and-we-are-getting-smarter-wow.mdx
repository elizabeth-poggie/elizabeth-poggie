...
Imagine you have a list of employees with columns for "Name", "Hire Date", and "Salary". You can easily sort the sheet by "Hire Date" to see who joined first.
...
Imagine you’re managing employee data and want to sort first by "Department" and then by "Hire Date" to see which employees have been with each department the longest.

# Exercise 2

In the workbook attached on Lea, in the exercise 1 tab, complete the following:

- Sort the sheet alphabetically by "Name"
- Sort a specific range by "Salary" in descending order (highest to lowest)
...
If you don't life `gif`s, you can refer to [here] for step by step instructions :)
