...
Indenting is part of every english assignment as it gives structure to your document. A quicker way to indent is with the `Tab` key. Alternatively if you want to make your life harder for yourself you can use these guys:

![demo](./assets/11.png)

## Formatting Revealed

Ever have a need to see what formating deicisons you made and want to double check them? Select this guy:

![demo](./assets/12.png)

It reveals all hidden formatting information in the document (for example tabs)

# Design Elements

## Horizontal Lines

Open this guy up if you want to modify structural elements of the page:

![demo](./assets/13.png)

## Images

Microsoft also gives you access to a extensive icon library and stock images should you ever need that to be included in your work.
