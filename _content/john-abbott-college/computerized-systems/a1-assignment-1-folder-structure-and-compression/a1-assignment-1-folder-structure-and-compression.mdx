...
In this section, you will create two new files and place them in the top-level folder.
...
- Create an empty Microsoft Excel document.
  - Save the file as `Excel1.xlsx` and place it inside the correct folder.
...
- ubmit the compressed folder to LEA under the `Assignment #1` section.
