...
Notice the different ways I used to declare functions in my above object 👀 However, what matters is staying consistent with what you choose.

Food for thought, how could we modify our `hasDiscountEligibility` function to be an object method instead?
