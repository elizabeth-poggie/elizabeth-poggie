...
Whatever that's written in vanilla JS can be done cleaner with jQuery. However before we explore the best way of doing this, we need to first understand what "DOM Ready" is.

# The jQuery way

Whatever that's written in vanilla JS can be done cleaner with jQuery. First import it at the top:
