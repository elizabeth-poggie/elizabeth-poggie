...
If you were determined enough, you could copy the source code from [github](https://github.com/jquery/jquery) nd paste it directly into your header `<script>` tag. While this is possible, it’s not the best practice and can make your simple HTML doc much beefier than it needs to be.
...
Using a CDN keeps your code clean and efficient. Copy-pasting the library code into your header is like reinventing the wheel. It's unnecessary and time-consuming. Stick to the CDN method.

## Do I need to memorize this?

Absolutely not. Just copy and paste the library import `<script>` tag when needed.
