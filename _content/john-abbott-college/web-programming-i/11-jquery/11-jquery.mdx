...
<body>
  ...
  <script>
    ...
    $("p").show();
    $("p").text("Wow!!!!");
    $("p").html("<strong>WOWOWOWOWOWOW</strong>");
...
Complete the following jQuery exercises:

- [Selectors](https://www.w3schools.com/jquery/exercise_jq.asp?filename=exercise_jq_selectors1)
- [Hide/Show](https://www.w3schools.com/jquery/exercise_jq.asp?filename=exercise_jq_hide_show1)
- [CSS](https://www.w3schools.com/jquery/exercise_jq.asp?filename=exercise_jq_css1)
...
Let's take this to the next level by adding a business section that tracks and updates business stats. We'll create three sections:

- _Available funds_: This shows the total revenue you've earned from selling paperclips.
- _Unsold Inventory_: This displays how many paperclips you have ready to sell.
- _Price per Clip_: This lets the user adjust the price of each paperclip, which will affect revenue and sales.
...
The goal is to get your project looking and behaving even more like [Universal Paperclips](https://www.decisionproblem.com/paperclips/index2.html), as captured below:
