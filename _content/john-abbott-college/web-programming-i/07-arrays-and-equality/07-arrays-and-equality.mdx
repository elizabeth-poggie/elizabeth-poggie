...
However not all properties are created equal. ere are a few key properties that are particularly useful:
...
So far we have been working mainly in CodePen, today is when we finally return to VSCode. Copy and paste the Pen on LEA and complete the exercise.
