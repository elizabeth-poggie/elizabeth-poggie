...
Constants: Check out where I define my constants 👉 [NOTES_BASE_FOLDER](https://github.com/elizabeth-poggie/elizabeth-poggie/blob/main/pages/notes/index.tsx#L16). Why? Well I can be sure that the notes I create will only ever be for John Abbott College.
