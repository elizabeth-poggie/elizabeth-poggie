...
Which of the following statements about Node.js is _NOT_ true?
...
- ✅ Node.js is a programming language designed for server-side scripting
- ❌ Node.js allows the execution of JavaScript code outside of a web browser

## Why?

Node.js is not a programming language. It is a runtime environment that allows JavaScript to be executed on the server side.
