...
title: "async/await execution flow && API params"
created: "2024-11-11"
number: 32
---
...
Why? `sleep(10000)` is a _synchronous_ function that pauses for 10 seconds.
...
- `limit=10` and `offset=20` are query parameters that limit the results to 10 items, starting from the 20th
