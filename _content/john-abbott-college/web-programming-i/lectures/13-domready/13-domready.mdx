...
What make's "this guy" so special? He created a mini startup called [Hoodmaps](https://hoodmaps.com/?ref=levels.io), building it in public from the very first line of code to a fully functioning web app that made it to the front page of Reddit, attracting over 300,000 users.

He recorded the entire journey on [Twitch](https://www.youtube.com/watch?v=FN144KdOIGM). If you're curious, you can explore all his other projects on his [Twitter](https://x.com/levelsio)
