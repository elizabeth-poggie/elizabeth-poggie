...
As an exercise, try setting up a project with node and installing `express` and `lodash` and try to use `lodash` in your index.js by looking through the [official docs](https://lodash.com/docs/4.17.15)
