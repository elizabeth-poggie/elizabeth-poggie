...
As an exercise, take time to replicate all those steps and ask me for help if you get stuck
...
- Head over to your `README.md`, what do you notice when you hover over a line?

# Final Notes

For this project, you will become best friends with postman. Take time to formulate your request there before diving into the code logic.
