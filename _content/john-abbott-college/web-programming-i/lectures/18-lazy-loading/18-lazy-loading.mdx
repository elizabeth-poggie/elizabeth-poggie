...
I'm adding some images to the assignment to guide you through the creation phase. I'll also be extending the deadline to the 14th. While I originally designed this assignment as a way to help you prepare for the upcoming test, I understand if that's not how you study best.

You'll still have a few extra days after the test to complete it if needed.
...
## How does this look like when you use it?
