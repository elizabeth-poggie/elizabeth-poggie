...
To enable auto-completion (autofill) for Jest in your code editor, you can configure your editor to recognize Jest's globals and test methods.

First, install types for Jest:
