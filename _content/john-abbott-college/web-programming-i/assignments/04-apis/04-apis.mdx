...
- Due: `November 14th, 2024 @ 11:59pm`
...
- Academic Integrity: The purpose of this assignment is to strengthen your logical thinking and syntax skills. Work independently to benefit fully from this assignment!!
...
Under the show details, you should also include:

- A list of all episodes, categorized by season.
- When any episode is clicked, the user should be redirected to its page
...
- While it might be tempting to rely on ChatGPT, remember that in a tech interview testing you on these exact concepts, you won’t have access to this kind of help. So, if you decide to use ChatGPT, _limit its use to styling in CSS_ rather than the JavaScript logic required above 👀
