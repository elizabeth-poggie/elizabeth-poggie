...
- As much as you may be tempted to use ChatGPT, keep in mind during a tech interview that tests you on these very concepts, you wont have access to that then. Consequently, if you choose to use it, keep it limited to you CSS style sheets and not the JavaScript Logic required above
