...
JavaScript’s journey of names: Mocha -> LiveScript -> JavaScript (Java was popular at the time) -> JScript (Marketing decision) -> ECMAScript (ES6, ES7, ES2017)
...
This era saw the rise and fall of ECMAScript 4, ActionScript, and Flash.
